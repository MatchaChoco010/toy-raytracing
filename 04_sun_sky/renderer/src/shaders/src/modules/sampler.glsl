...
SAMPLER_GLSL_DEFINE_PERMUTE_FUNC(3, 6, 7)
SAMPLER_GLSL_DEFINE_TO_BASE_S_FUNC(3, 6, 7)
SAMPLER_GLSL_DEFINE_EVAL_POLY_FUNC(3, 6, 7)
SAMPLER_GLSL_DEFINE_OFFSET_FUNC(3, 6, 7)
SAMPLER_GLSL_DEFINE_BUSH_OA_FUNC(3, 6, 7)
SAMPLER_GLSL_DEFINE_SAMPLE_RANDOM_FUNC(3, 6, 7)
